...
(function() {
    'use strict'
    if(!GM_getValue('user')){
        GM_setValue('user', prompt('Enter your main nation name.'))
    }
            ...
            switch(e.keyCode){
                ...
                case 65:
                    if(document.querySelector('ol li:not(:has(.nukedestroyedicon)) a')){
                        location.href = document.querySelectorAll('ol li:not(:has(.nukedestroyedicon)) a')[Math.floor(Math.random() * document.querySelectorAll('ol li:not(:has(.nukedestroyedicon)) a').length)].href + '?target=' + document.querySelector('ol li:not(:has(.nukedestroyedicon)) a').href.split('nation=')[1].split('/')[0].split('?')[0];
                ...
                case 84:
                    ...
                    if(v > 150){
                        ...
                        location.href = 'https://www.nationstates.net/page=faction/fid=' + GM_getValue('targetFac') + '/view=nations?start=' + GM_getValue('page');
                    }else{
